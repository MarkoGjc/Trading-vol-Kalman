...
def main():
    ...
    df15m["pi_high"] = pi_high_test
    df15m["slope_pct_mix"] = slope_pct_mix_test
    path = r"C:\Users\Gajic\OneDrive - Université Paris-Dauphine\Trading\Trading-vol-Kalman\Filters\Kalman\outpout_filter\BTCUSDT_15m_imm_filtered.csv"
    df15m.to_csv(path, index=False, encoding="utf-8")
